...
links:
    ...
    - url: https://github.com/DSL-Demo-f2026/readings/blob/main/02_linear-regression/reading-list.md
      name: "reading - reading-list.md"
---
Materials for session 2. Open the links above (you must be an enrolled member of `DSL-Demo-f2026`).
